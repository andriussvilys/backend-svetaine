...
var PinchToZoom = (function (_super) {
    ...
    function PinchToZoom(props) {
        ...
        _this.offset = null;
        _this.transformed = false;
        _this.menuDown = document.getElementById("TagsMenu") && document.getElementById("TagsMenu").classList.contains("show-menu");
        _this.infoUp = document.getElementById("ArtworkInfo") && document.getElementById("ArtworkInfo").classList.contains("info-up");
        _this.dragPoint = null;
        _this.dragOrigin = null;
        _this.nextTranslate = null
        _this.state = {
    ...
    PinchToZoom.prototype.componentDidMount = function () {
        const load = () => {
            if(this.props.mobile){
                var _this = this;
                setTimeout(function () {
                    var startEvent = document.createEvent('TouchEvent');
                    startEvent.initEvent('touchstart', true, true);
                    var endEvent = document.createEvent('TouchEvent');
    ...
    PinchToZoom.prototype.onPinchStart = function (syntheticEvent) {
        ...
        document.getElementById("foreground-img").src = this.props.state.enlarge.foreground.desktopPath
    };
    ...
    PinchToZoom.prototype.onPanMove = function (syntheticEvent, props) {
    ...
    PinchToZoom.prototype.onPanEnd = function (props) {
        // if(!this.transformed){
        //     // if(this.offset){
        ...
        //     const bottomBar = document.getElementById("enlarge-info")
        //     // const currentTransformValue = container.clientHeight - bottomBar.clientHeight - artworkInfo.getBoundingClientRect().top


        //     const menu = document.getElementById("TagsMenu")
        //     if(this.offset){
        //         //check that swpi length is more than 50px
        //         if(Math.abs(this.offset.y) > 50 && Math.abs(this.offset.y) > Math.abs(this.offset.x)){
        //             //swipe down
        //             // const currentTransformValue = container.clientHeight - bottomBar.clientHeight - artworkInfo.getBoundingClientRect().top
        ...
        //             // // console.log(this.offset.y)
        //             // let transformValue = Math.round(-currentTransformValue + this.offset.y)
        //             // console.log("transformValue")
        //             // console.log(transformValue)
        //             // if(transformValue < -artworkInfo.clientHeight){
        //             //     transformValue = -artworkInfo.clientHeight
        //             // }
        //             // if(transformValue > 0){
        //             //     transformValue = 0
        ...
        //             // }
        //             // if(this.offset.y > 0){
        //             //     console.log(`swipe down by ${transformValue}px`)
        //             //     artworkInfo.style.transform = `translateY(${transformValue}px)`
        //             //     this.infoUp = false
        ...
        //             // //swipe up
        //             // else{
        //             //     console.log(`swipe up by ${transformValue}px`)
        //             //     artworkInfo.style.transform = `translateY(${transformValue}px)`
        ...
        //             //             // artworkInfo.style.transform = `translateY${-this.offset.y}px`
        //             //         }
        //             //         // else{
        ...
        //                 this.offset = null
        //             }
        //         // else{props.closeEnlarge()}
        //         }
        // }
        // else{
        //     if(this.offset){
        //         if(Math.abs(this.offset.x) < 10){
        //         props.closeEnlarge()
        //         console.log("offset less than 50")
        //         }
        //         else if(Math.abs(this.offset.x) > 0){
        //             props.viewPrev(-1)
        //         }
        //         else{
        //             props.viewNext(+1)
        ...
        switch (nativeEvent.touches.length) {
            ...
            default:
                if (this.currentGesture === GUESTURE_TYPE.PAN) {
                    this.onPanMove(syntheticEvent, this.props);
                }
        }
    };
    PinchToZoom.prototype.handleTouchEnd = function (syntheticEvent) {
        ...
        if (this.currentGesture === GUESTURE_TYPE.PAN) {
            ...
            if(syntheticEvent.nativeEvent.isTrusted){
                this.onPanEnd(this.props.panEvent);
            }
    ...
    PinchToZoom.prototype.render = function () {
        ...
        return (React.createElement("div", {id: "pinchContainer", className: className.concat(classNameList.join(' ')), style: containerInlineStyle, onTouchStart: function (e) { return _this.handleTouchStart(e); }, onTouchMove: function (e) { return _this.handleTouchMove(e); }, onTouchEnd: function (e) { return _this.handleTouchEnd(e); }, ref: function (c) {
                _this.zoomAreaContainer = c || undefined;
            } },
            React.createElement("div", {id: "pinchZoomArea", className: "pinch-to-zoom-area", style: zoomAreaInlineStyle, ref: function (c) {
